                  ...
                  {needsCompany && (
                    ...
                    >
                      ...
                      {ownedCompanies.map(c => {
                        const idx = (c.stage === 'L' || c.stage === 0) ? 0 : (c.stage === 'R' || c.stage === 1) ? 1 : (c.stage === 'G' || c.stage === 2) ? 2 : 3;
                        return (
                          <option key={c.name} value={c.name}>{c.name} (Stage: {['Launch', 'Retain', 'Grow', 'Scale'][idx]})</option>
                        );
                      })}
                    </select>
                  )}
